...
--
-- Name: crashreport; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: crashreport_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE crashreport_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: crashreport_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE crashreport_id_seq OWNED BY crashreport.id;
...
--
-- Name: paypal_ipn; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: paypal_ipn_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: paypal_ipn_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
ALTER TABLE ONLY crashreport ALTER COLUMN id SET DEFAULT nextval('crashreport_id_seq'::regclass);
...
--
-- Name: crashreport_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: paypal_ipn_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: crashreport_member_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY crashreport
    ADD CONSTRAINT crashreport_member_id_fkey FOREIGN KEY (member_id) REFERENCES member(id);
